...
import { getInternationalProjectBySlug } from '../data/internationalProjects';

const InternationalProjectDetail = () => {
  const { slug } = useParams();
  const news = getInternationalProjectBySlug(slug);
      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <article className="max-w-4xl mx-auto rounded-2xl bg-white/95 border border-[#E5C0C8]/60 shadow-md p-6 md:p-10">
            <div className="mb-6">
              <Link to="/projects" className="text-sm text-[#194F92] hover:underline">
                返回工程列表
              </Link>
            </div>
...
export default InternationalProjectDetail;
